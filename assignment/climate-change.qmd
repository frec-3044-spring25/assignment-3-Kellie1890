...
**Answer 6:**
I googled 'how to calculate a rolling average' and one of the top sources was stackoverflow so that is what I ended up using. I overall ended up using code from multiple sources to see which one worked in the end.
```{r}
